...
this.reply(m.chat, `*[❗] @${room.p2.split`@`[0]} 𝚁𝙴𝙹𝙴𝙲𝚃𝙸𝙾𝙽 𝙾𝙵 𝚃𝙷𝙴 𝙿𝚅𝙿, 𝚃𝙷𝙴 𝙿𝚅𝙿 𝙸𝚂 𝙲𝙰𝙽𝙲𝙴𝙻𝙻𝙴𝙳*`, m)
...
this.sendButton(m.chat, `*[❗] @${(room.pilih ? room.p2 : room.p).split`@`[0]} 𝚈𝙾𝚄 𝙳𝙸𝙳 𝙽𝙾𝚃 𝙲𝙷𝙾𝙾𝚂𝙴 𝙰𝙽𝚈 𝙾𝙿𝚃𝙸𝙾𝙽, 𝙴𝙽𝙳 𝙾𝙵 𝚃𝙷𝙴 𝙿𝚅𝙿*`.trim(), wm, null, [['𝙼𝙴𝙽𝚄 𝙿𝚁𝙸𝙽𝙲𝙸𝙿𝙰𝙻', '/menu']], m)    
...
if (!room.pilih2) this.reply(room.p2, '*[❗] 𝚃𝙷𝙴 𝙾𝙿𝙿𝙾𝙽𝙴𝙽𝚃 𝙰𝙷 𝙲𝙷𝙾𝚂𝙴𝙽, 𝙸𝚃 𝙸𝚂 𝚈𝙾𝚄𝚁 𝚃𝚄𝚁𝙽 𝚃𝙾 𝙲𝙷𝙾𝙾𝚂𝙴!!*', 0)
}
if (jwb2 && reg.test(m.text) && !room.pilih2 && !m.isGroup) {
room.pilih2 = reg.exec(m.text.toLowerCase())[0]
room.text2 = m.text
m.reply(`*[ ✔ ] 𝚈𝙾𝚄 𝙷𝙰𝚅𝙴 𝙲𝙷𝙾𝚂𝙴𝙽 ${m.text}* ${!room.pilih ? `\n\n*𝚆𝙰𝙸𝚃𝙸𝙽𝙶 𝙵𝙾𝚁 𝚃𝙷𝙴 𝙾𝙿𝙿𝙾𝙽𝙴𝙽𝚃 𝚃𝙾 𝙲𝙷𝙾𝙾𝚂𝙴*` : ''}`)
if (!room.pilih) this.reply(room.p, '*[❗] 𝚃𝙷𝙴 𝙾𝙿𝙿𝙾𝙽𝙴𝙽𝚃 𝙰𝙷 𝙲𝙷𝙾𝚂𝙴𝙽, 𝙸𝚃 𝙸𝚂 𝚈𝙾𝚄𝚁 𝚃𝚄𝚁𝙽 𝚃𝙾 𝙲𝙷𝙾𝙾𝚂𝙴!!*', 0)
}
...
*◉ @${room.p.split`@`[0]} (${room.text}) ${tie ? '' : room.p == win ? ` 𝚆𝙸𝙽 \n${room.poin} 𝚇𝙿\n𝚃𝙸𝙴, 𝙱𝙾𝙽𝚄𝚂: ${room.poin_bot} 𝚇𝙿` : ` 𝙻𝙾𝚂𝚃 ${room.poin_lose} 𝚇𝙿`}*
*◉ @${room.p2.split`@`[0]} (${room.text2}) ${tie ? '' : room.p2 == win ? ` 𝚆𝙸𝙽 \n${room.poin} 𝚇𝙿\n𝚃𝙸𝙴, 𝙱𝙾𝙽𝚄𝚂: ${room.poin_bot} 𝚇𝙿` : ` 𝙻𝙾𝚂𝚃 ${room.poin_lose} 𝚇𝙿`}*
